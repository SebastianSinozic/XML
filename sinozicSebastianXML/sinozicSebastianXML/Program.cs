...
namespace Programming_xml
{
    ...
    public class Tester
    {
        ...
        static void Main()
        {
            string dir = @"D:/Documents/xmlDocument";   //stvaranje direktorija na odabrano mjesto
            ...
            oneCustomer.Save("D:/Documents/xmlDocument/prvaPretraga.xml");
            // drugo pretraživanje
            ...
            oneCustomer.Save("D:/Documents/xmlDocument/drugaPretraga.xml");
            // treće pretraživanje
            ...
            oneCustomer.Save("D:/Documents/xmlDocument/cetvrtaPretraga.xml");
            Console.Read();
        }
    } // kraj class
} // kraj namespace